...
class Ui_WSettingsSound(object):
    def setupUi(self, WSettingsSound):
        ...
        self.label_23 = QtWidgets.QLabel(WSettingsSound)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.noisevolume.setDecimals(1)
        self.noisevolume.setMaximum(100.0)
        self.noisevolume.setSingleStep(0.1)
    ...
    def retranslateUi(self, WSettingsSound):
        ...
        self.label_23.setText(_translate("WSettingsSound", "Volume (%)"))
