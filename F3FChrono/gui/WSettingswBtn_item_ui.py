...
class Ui_WSettingwBtn_item(object):
    ...
    def retranslateUi(self, WSettingwBtn_item):
        ...
        self.comboBox_SP.setItemText(1, _translate("WSettingwBtn_item", "Btn Next"))
        self.comboBox_SP.setItemText(2, _translate("WSettingwBtn_item", "Base A"))
        self.comboBox_SP.setItemText(3, _translate("WSettingwBtn_item", "Base B"))
        ...
        self.comboBox_LP.setItemText(1, _translate("WSettingwBtn_item", "Btn Next"))
        self.comboBox_LP.setItemText(2, _translate("WSettingwBtn_item", "Base A"))
        self.comboBox_LP.setItemText(3, _translate("WSettingwBtn_item", "Base B"))
