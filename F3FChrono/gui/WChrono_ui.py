...
class Ui_WChrono(object):
    def setupUi(self, WChrono):
        ...
        self.gridLayout.addWidget(self.penalty_1000, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.penalty_100, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.WindInfo, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.btn_clear_penalty, 1, 2, 2, 2)
        ...
        self.gridLayout.addWidget(self.nullFlight, 3, 2, 2, 1)
        ...
        self.gridLayout.addWidget(self.reflight, 3, 3, 2, 1)
