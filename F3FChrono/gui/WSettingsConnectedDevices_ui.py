...
class Ui_WSettingsConnectedDevices(object):
    def setupUi(self, WSettingsConnectedDevices):
        ...
        self.gridLayout.addWidget(self.btn_valid, 16, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_cancel, 16, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_back, 15, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.btn_base_settings, 14, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.wbtn_settings, 14, 1, 1, 1)
        ...
        self.display = QtWidgets.QCheckBox(WSettingsConnectedDevices)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.display, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.WeatherStation_Rain, 10, 0, 1, 1)
    ...
    def retranslateUi(self, WSettingsConnectedDevices):
        ...
        self.display.setText(_translate("WSettingsConnectedDevices", "F3F Display"))
        self.WeatherStation_Rain.setText(_translate("WSettingsConnectedDevices", "rain"))
